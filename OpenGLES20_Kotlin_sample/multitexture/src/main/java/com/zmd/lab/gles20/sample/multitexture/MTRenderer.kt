...
class MTRenderer(val context: Context): GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        val bitmap2 = getBitmap("img04.jpg")
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, texNames[1])
        GLES20.glUniform1i(uSampler2, 1)
    ...
    private fun initProgram() {
        ...
        uSampler2 = GLES20.glGetUniformLocation(program, "uSampler2")
    }
