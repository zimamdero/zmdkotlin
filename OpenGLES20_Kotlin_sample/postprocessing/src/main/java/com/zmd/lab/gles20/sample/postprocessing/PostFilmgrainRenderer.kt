...
class PostFilmgrainRenderer(val context: Context): GLSurfaceView.Renderer {
    ...
    private var uNoiseSampler = 0
    private var uTime = 0
    private var uInverseTextureSize = 0
    ...
    private var noseTexNames = IntArray(1)
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        try {
            input = assetManager.open("noise.png")
        ...
        noseTexNames = IntArray(1)
        GLES20.glGenTextures(1, noseTexNames, 0)
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, noseTexNames[0])
    ...
    override fun onSurfaceChanged(gl: GL10?, width: Int, height: Int) {
        ...
        GLES20.glUniform2f(uInverseTextureSize, 1.0f / this.width, 1.0f / this.height)
    }
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, noseTexNames[0])
        GLES20.glUniform1i(uNoiseSampler, 1)
    ...
    fun initProgram() {
        ...
        uNoiseSampler = GLES20.glGetUniformLocation(program, "uNoiseSampler")
        uTime = GLES20.glGetUniformLocation(program, "uTime")
        uInverseTextureSize = GLES20.glGetUniformLocation(program, "uInverseTextureSize")
    }
